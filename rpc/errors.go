...
var (
	...
	ErrRPCServerInitialized = errors.New("the service has already been initialized") // 服务器已经初始化过
	ErrRPCServerIsRunning   = errors.New("the rpc server is running")                // 服务器运行中
)
